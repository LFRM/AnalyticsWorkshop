...
# script from: https://github.com/jeknov/movieRec
...
# path
# setwd("/Users/francisco/desktop/movieRecF")

# data loading
movies <- read.csv("movies.csv",stringsAsFactors=FALSE)
ratings <- read.csv("ratings.csv")

# look at the data: how popular is Heat?
ratings[ratings$movieId==6,]
boxplot(ratings[ratings$movieId==6,]$rating)
...
write.csv(search_matrix, "search.csv",row.names=FALSE)
...
# hist(binaryratings[binaryratings$movieId==6,]$rating)
